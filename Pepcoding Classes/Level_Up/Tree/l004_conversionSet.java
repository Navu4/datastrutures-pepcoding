public class l004_conversionSet {
    ...
    // 1. Convert Binary Tree to Doubly LinkedList
    // 2. Sort the DLL using Merge Sort Algorithm
    // 3. Convert DLL to BST using Inorder(using mid node as root)
