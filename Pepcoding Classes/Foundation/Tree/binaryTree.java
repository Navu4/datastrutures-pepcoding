...
public class binaryTree {
    ...
    // PreOrder Traversal
    public static void preOrderTraversal(Node root, ArrayList<int> al){
        if(root == null){
            return;
        }
    ...
    // InOrder Traversal
    public static void inOrderTraversal(Node root, ArrayList<int> al){
        if(root == null){
            return;
        }
    ...
    public static void postOrderTraversal(No
    de root, ArrayList<int> al){
        if(root == null){
            return;
        }
    ...
    // Basic Funtions
    // Size od Binary Tree -- No. of Nodes
    ...
    // Sum of all the values in the tree
