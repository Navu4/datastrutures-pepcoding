public class questions {
    ...
    public static LinkedList getProductWithASingleNode(LinkedList ll, Node node) {
        LinkedList ans = new LinkedList();
        int sizell = ll.size() - 1;

        int carry = 0;
        while (sizell-- >= 0 || carry > 0) {

            int mul = node.data * getAt(sizell) + carry;
    ...
    public static LinkedList multiplyTwoLists(LinkedList one, LinkedList two) {
